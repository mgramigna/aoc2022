...
impl Cave {
    ...
    fn produce_sand(&mut self) -> bool {
        ...
        loop {
            ...
            if sand_coord.x + 1 == self.size_x || sand_coord.y + 1 == self.size_y {
                voided = true;
                break;
            }

            if sand_coord.x == 0 || sand_coord.y == 0 {
                voided = true;
                break;
            }
        }
...
fn main() {
    ...
    let mut cave: Cave = Cave::new(max_x + 1, max_y + 1, 500 - min_x, 0);
